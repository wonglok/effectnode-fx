...
import { vec4, mod, tslFn, float, floor, overloadingFn, mul, sub, vec3, fract, abs, dot, lessThan, vec2, step, clamp, max } from 'three/nodes';
...
const snoise = tslFn(([v_immutable]) => {
...
export { permute, taylorInvSqrt, grad4, snoise };
