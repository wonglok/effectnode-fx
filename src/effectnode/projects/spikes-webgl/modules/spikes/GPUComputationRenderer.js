 ...
 * let velVar = gpuCompute.addVariable( "textureVelocity", fragmentShaderVel, pos0 );
 * let posVar = gpuCompute.addVariable( "texturePosition", fragmentShaderPos, vel0 );
 *
 ...
 *
 * let myFilter1 = gpuCompute.createShaderMaterial( myFilterFragmentShader1, { theTexture: { value: null } } );
 * let myFilter2 = gpuCompute.createShaderMaterial( myFilterFragmentShader2, { theTexture: { value: null } } );
 *
 * let inputTexture = gpuCompute.createTexture();
 *
 * // Fill in here inputTexture...
 *
 * myFilter1.uniforms.theTexture.value = inputTexture;
 *
 * let myRenderTarget = gpuCompute.createRenderTarget();
 * myFilter2.uniforms.theTexture.value = myRenderTarget.texture;
 *
 * let outputRenderTarget = gpuCompute.createRenderTarget();
 *
