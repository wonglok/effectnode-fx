                        ...
                        <ul className='md:flex-col md:min-w-full flex flex-col list-none md:mb-4'>
                            <li className='items-center'>
                                <Link legacyBehavior href='/auth/login'>
                                    ...
                                    >
                                        <i className='fas fa-fingerprint text-gray-400 mr-2 text-sm'></i> Login
                                    </a>
                                </Link>
                            </li>
                            ...
                            <li className='items-center'>
                                <Link legacyBehavior href='/landing'>
                                    <a
                                        ...
                                        className='text-gray-700 hover:text-gray-500 text-xs uppercase py-3 font-bold block'
                                    >
                                        <i className='fas fa-newspaper text-gray-400 mr-2 text-sm'></i> Landing Page
                                    </a>
                                </Link>
                            </li>
                            ...
                            <li className='items-center'>
                                <Link legacyBehavior href='/profile'>
                                    <a
                                        ...
                                        className='text-gray-700 hover:text-gray-500 text-xs uppercase py-3 font-bold block'
                                    >
                                        <i className='fas fa-user-circle text-gray-400 mr-2 text-sm'></i> Profile
                                        Page
                                    </a>
                                </Link>
                            </li>
